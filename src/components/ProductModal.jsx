...
const handleUpdateProduct = async () => {
    ...
    const handleFileChange = async(event)=>{
        ...
        try{
          const fileRef = await axios.post(`${BASE_URL}/v2/api/${API_PATH}/admin/upload`,formDate);
          console.log("上傳圖片成功",fileRef.data);
          const uploadedImageUrl = fileRef.data.imageUrl;
